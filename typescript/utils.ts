...
export function updateLeaderboard(
	...
	try {
		...
		let leaderboard: { username: string; score: number }[] = storedData
 ...
 */
export function getLeaderboard(leaderboardName: string): void {
	// Retrieve leaderboard data from localStorage
	const leaderboardData = localStorage.getItem(leaderboardName);
	let leaderboard: { username: string; score: number }[] = leaderboardData
